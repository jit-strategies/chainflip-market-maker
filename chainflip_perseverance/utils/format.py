...
from chainflip_perseverance.utils.constants import ASSETS, UNIT_CONVERTER, DECIMALS
...
def deserialize_balance(response: dict) -> dict:
    """
    deserialize balance response from jsonrpc
    :param response: dict response
    """
    return response['result']


def u256_fixed_to_float(u256_hex_str: str, asset_1: str, asset_2: str = 'Usdc') -> float:
    """
